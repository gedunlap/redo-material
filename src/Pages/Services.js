    ...
    <div className='services'>
      ...
      <div className='servicesColor'>
        <div className='colorTextBox'>
          <h2>COLOR</h2><br />
          <h4 className='colorLabel'>Highlights: <br /> <span>$325+ <BiRightArrow size="15"/> 3hr</span></h4>
          ...
          <h4 className='colorLabel'>Gloss | Toner | Glaze: <br /> <span>$85+ <BiRightArrow size="15"/> 1hr</span></h4>
          ...
          <h4 className='colorLabel'>Color Correction | Complete Color Change: <br /> <span>$325+ <BiRightArrow size="15"/> 3hr</span></h4>
        </div>
      ...
      <div className='servicesStyle'>
        ...
        <div className='stylingTextBox'>
          <h2>STYLING</h2><br />
          <h4 className='stylingLabel'>Haircut: <br /> <span>$115+ <BiRightArrow size="15"/> 1hr 15min</span></h4>
          <p className='stylingText'>Service includes blow dry/style.</p><br />
          <h4 className='stylingLabel'>Blow Dry: <br /> <span>$70+ <BiRightArrow size="15"/> 45min</span></h4>
          <br />
          <h4 className='stylingLabel'>Up do | Special Occasion: <br /> <span>$95+ <BiRightArrow size="15"/> 1hr</span></h4>
          <br />
          <h4 className='stylingLabel'>Men's Haircut: <br /> <span>$55+ <BiRightArrow size="15" /> 1hr</span></h4>
          <br />
          <h2>EXTENSIONS</h2>
