  ...
  return (
    <div className='about'>
      <div className='aboutText'>
        <h2>About</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora alias iste natus sint officiis enim, quos voluptatum aspernatur cupiditate officia quisquam laborum libero necessitatibus quaerat aliquid ad, delectus voluptas nisi! <br />
